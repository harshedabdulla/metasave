...
const Signup = () => {
  ...
  return (
    <div className="bg-[radial-gradient(ellipse_at_bottom_left,_var(--tw-gradient-stops))] from-pink-400 via-pink-200 to-sky-300 min-h-screen h-full flex justify-center items-center">
