...
declare const SessionKeyPlugin_: {
    ...
    accountMethods: (_account: IMSCA<any, any, any>) => {
        encodeExecuteWithSessionKeyData: ({ args, }: GetFunctionArgs<typeof SessionKeyPluginExecutionFunctionAbi, 'executeWithSessionKey'>) => `0x${string}`;
        encodeAddSessionKeyData: ({ args, }: GetFunctionArgs<typeof SessionKeyPluginExecutionFunctionAbi, 'addSessionKey'>) => `0x${string}`;
        encodeRemoveSessionKeyData: ({ args, }: GetFunctionArgs<typeof SessionKeyPluginExecutionFunctionAbi, 'removeSessionKey'>) => `0x${string}`;
        encodeRotateSessionKeyData: ({ args, }: GetFunctionArgs<typeof SessionKeyPluginExecutionFunctionAbi, 'rotateSessionKey'>) => `0x${string}`;
        encodeUpdateKeyPermissionsData: ({ args, }: GetFunctionArgs<typeof SessionKeyPluginExecutionFunctionAbi, 'updateKeyPermissions'>) => `0x${string}`;
    };
    providerMethods: <TTransport extends SupportedTransports, P extends ISmartAccountProvider<TTransport> & {
        ...
        executeWithSessionKey: ({ args, }: GetFunctionArgs<typeof SessionKeyPluginExecutionFunctionAbi, 'executeWithSessionKey'>, overrides?: UserOperationOverrides) => Promise<import("@alchemy/aa-core").SendUserOperationResult>;
        addSessionKey: ({ args, }: GetFunctionArgs<typeof SessionKeyPluginExecutionFunctionAbi, 'addSessionKey'>, overrides?: UserOperationOverrides) => Promise<import("@alchemy/aa-core").SendUserOperationResult>;
        removeSessionKey: ({ args, }: GetFunctionArgs<typeof SessionKeyPluginExecutionFunctionAbi, 'removeSessionKey'>, overrides?: UserOperationOverrides) => Promise<import("@alchemy/aa-core").SendUserOperationResult>;
        rotateSessionKey: ({ args, }: GetFunctionArgs<typeof SessionKeyPluginExecutionFunctionAbi, 'rotateSessionKey'>, overrides?: UserOperationOverrides) => Promise<import("@alchemy/aa-core").SendUserOperationResult>;
        updateKeyPermissions: ({ args, }: GetFunctionArgs<typeof SessionKeyPluginExecutionFunctionAbi, 'updateKeyPermissions'>, overrides?: UserOperationOverrides) => Promise<import("@alchemy/aa-core").SendUserOperationResult>;
...
export declare const SessionKeyPlugin: Plugin<ReturnType<(typeof SessionKeyPlugin_)['accountMethods']>, ReturnType<(typeof SessionKeyPlugin_)['providerMethods']>, typeof SessionKeyPluginAbi>;
