...
exports.SessionKeyPermissionsBuilder = void 0;
const viem_1 = require("viem");
const SessionKeyPermissionsUpdatesAbi_js_1 = require("./SessionKeyPermissionsUpdatesAbi.js");
...
class SessionKeyPermissionsBuilder {
    ...
    encode() {
        return [
            ...
            ...this._erc20TokenSpendLimits.map((erc20SpendLimit) => (0, viem_1.encodeFunctionData)({
                abi: SessionKeyPermissionsUpdatesAbi_js_1.SessionKeyPermissionsUpdatesAbi,
            ...
            this.encodeIfDefined((spendLimit) => (0, viem_1.encodeFunctionData)({
                abi: SessionKeyPermissionsUpdatesAbi_js_1.SessionKeyPermissionsUpdatesAbi,
                functionName: "setGasSpendLimit",
                args: [spendLimit.spendLimit, spendLimit.refreshInterval ?? 0],
            }), this._gasSpendLimit),
            this.encodeIfDefined((paymaster) => (0, viem_1.encodeFunctionData)({
                abi: SessionKeyPermissionsUpdatesAbi_js_1.SessionKeyPermissionsUpdatesAbi,
...
exports.SessionKeyPermissionsBuilder = SessionKeyPermissionsBuilder;
