...
exports.MultiOwnerPluginAbi = exports.MultiOwnerPluginExecutionFunctionAbi = exports.MultiOwnerPlugin = void 0;
...
const MultiOwnerPlugin_ = {
    ...
    getContract: (rpcClient, address) => (0, viem_1.getContract)({
        ...
        abi: exports.MultiOwnerPluginAbi,
    ...
    accountMethods: (account) => ({
        ...
        readIsValidSignature: async ({ args, }) => {
            return account.rpcProvider.readContract({
                address: await account.getAddress(),
                abi: exports.MultiOwnerPluginExecutionFunctionAbi,
                functionName: 'isValidSignature',
...
exports.MultiOwnerPlugin = MultiOwnerPlugin_;
exports.MultiOwnerPluginExecutionFunctionAbi = [
    {
