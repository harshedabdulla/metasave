...
declare const MultiOwnerPlugin_: {
    ...
    accountMethods: (account: IMSCA<any, any, any>) => {
        encodeUpdateOwnersData: ({ args, }: GetFunctionArgs<typeof MultiOwnerPluginExecutionFunctionAbi, 'updateOwners'>) => `0x${string}`;
        ...
        encodeIsValidSignatureData: ({ args, }: GetFunctionArgs<typeof MultiOwnerPluginExecutionFunctionAbi, 'isValidSignature'>) => `0x${string}`;
        readIsValidSignature: ({ args, }: GetFunctionArgs<typeof MultiOwnerPluginExecutionFunctionAbi, 'isValidSignature'>) => Promise<`0x${string}`>;
    };
...
export declare const MultiOwnerPlugin: Plugin<ReturnType<(typeof MultiOwnerPlugin_)['accountMethods']>, ReturnType<(typeof MultiOwnerPlugin_)['providerMethods']>, typeof MultiOwnerPluginAbi>;
