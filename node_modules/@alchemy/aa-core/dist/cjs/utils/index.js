...
exports.pick = exports.filterUndefined = exports.isPercentage = exports.isBigNumberish = exports.defineReadOnly = exports.getUserOperationHash = exports.deepHexlify = exports.resolveProperties = exports.asyncPipe = exports.getChain = void 0;
...
function isBigNumberish(x) {
    return x != null && schema_js_1.BigNumberishSchema.safeParse(x).success;
}
exports.isBigNumberish = isBigNumberish;
function isPercentage(x) {
    return x != null && schema_js_1.PercentageSchema.safeParse(x).success;
}
