...
export interface ISmartAccountProvider<TTransport extends SupportedTransports = Transport> {
     ...
     */
    connect<TAccount extends ISmartContractAccount>(fn: (provider: PublicErc4337Client<TTransport> | PublicErc4337Client<HttpTransport>) => TAccount): IsUndefined<TAccount["providerDecorators"]> extends true ? this & {
        account: TAccount;
    } : this & {
        account: TAccount;
