...
import { createContext, useEffect, memo, useState, useMemo, useCallback, useContext } from 'react';
  ...
  return /*#__PURE__*/jsxs("div", {
    ...
    children: [/*#__PURE__*/jsx("ul", {
      ...
      children: Object.keys(socialLoginsConfig.loginMethods).map(method => {
        ...
        const imageId = method === LOGIN_PROVIDER.TWITTER ? `login-twitter-x${isDark || isPrimaryBtn ? "-light" : "-dark"}` : `login-${method}${isDark || isPrimaryBtn ? "-light" : "-dark"}`;
        const hoverId = `login-${method}-active`;
        const hoverImage = method === LOGIN_PROVIDER.APPLE || method === LOGIN_PROVIDER.GITHUB || method === LOGIN_PROVIDER.TWITTER ? imageId : hoverId;
        ...
        const loginMethodSpan = classNames("w3a-adapter-item", (socialLoginsConfig === null || socialLoginsConfig === void 0 || (_socialLoginsConfig$u3 = socialLoginsConfig.uiConfig) === null || _socialLoginsConfig$u3 === void 0 ? void 0 : _socialLoginsConfig$u3.loginGridCol) === 2 ? "col-span-3" : "col-span-2");
...
class LoginModal extends SafeEventEmitter {
  constructor(_uiConfig) {
    ...
    _defineProperty(this, "initModal", async () => {
      ...
      if (useLang === "de") {
        import('./german-SYmK-a-e.js').then(messages => {
        ...
        import('./japanese-Zd4lzpvO.js').then(messages => {
          i18nInstance.addResourceBundle(useLang, "translation", messages.default);
          return i18nInstance.changeLanguage(useLang);
        }).catch(error => {
          log.error(error);
        ...
        import('./korean-4betESnt.js').then(messages => {
          i18nInstance.addResourceBundle(useLang, "translation", messages.default);
          return i18nInstance.changeLanguage(useLang);
        }).catch(error => {
          log.error(error);
        ...
        import('./mandarin-JJjRWyWU.js').then(messages => {
          i18nInstance.addResourceBundle(useLang, "translation", messages.default);
          return i18nInstance.changeLanguage(useLang);
        }).catch(error => {
          log.error(error);
        ...
        import('./spanish-EYsDIJxY.js').then(messages => {
          i18nInstance.addResourceBundle(useLang, "translation", messages.default);
          return i18nInstance.changeLanguage(useLang);
        }).catch(error => {
          log.error(error);
        ...
        import('./french-pSBrSTq9.js').then(messages => {
          i18nInstance.addResourceBundle(useLang, "translation", messages.default);
          return i18nInstance.changeLanguage(useLang);
        }).catch(error => {
          log.error(error);
        ...
        import('./portuguese-XRwHh0W4.js').then(messages => {
          i18nInstance.addResourceBundle(useLang, "translation", messages.default);
          return i18nInstance.changeLanguage(useLang);
        }).catch(error => {
          log.error(error);
        ...
        import('./dutch-PZr73RiR.js').then(messages => {
          i18nInstance.addResourceBundle(useLang, "translation", messages.default);
          return i18nInstance.changeLanguage(useLang);
        }).catch(error => {
          log.error(error);
        ...
        import('./turkish-8FUw6Nzr.js').then(messages => {
          i18nInstance.addResourceBundle(useLang, "translation", messages.default);
          return i18nInstance.changeLanguage(useLang);
        }).catch(error => {
          log.error(error);
