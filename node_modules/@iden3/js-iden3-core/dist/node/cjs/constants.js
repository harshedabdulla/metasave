...
exports.DidMethodNetwork = {
    [exports.DidMethod.Iden3]: {
        ...
        [`${exports.Blockchain.Polygon}:${exports.NetworkId.Main}`]: 0b00010000 | 0b00000001,
        [`${exports.Blockchain.Polygon}:${exports.NetworkId.Mumbai}`]: 0b00010000 | 0b00000010,
        [`${exports.Blockchain.Ethereum}:${exports.NetworkId.Main}`]: 0b00100000 | 0b00000001,
        [`${exports.Blockchain.Ethereum}:${exports.NetworkId.Goerli}`]: 0b00100000 | 0b00000010,
        [`${exports.Blockchain.Ethereum}:${exports.NetworkId.Sepolia}`]: 0b00100000 | 0b00000011,
        [`${exports.Blockchain.ZkEVM}:${exports.NetworkId.Main}`]: 0b00110000 | 0b00000001,
        [`${exports.Blockchain.ZkEVM}:${exports.NetworkId.Test}`]: 0b00110000 | 0b00000010
    },
    ...
    [exports.DidMethod.Other]: {
        [`${exports.Blockchain.Unknown}:${exports.NetworkId.Unknown}`]: 0b11111111
    }
};
