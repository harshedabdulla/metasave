...
import { AuthV2Inputs, CircuitId, Operators, Query, StateTransitionInputs, ValueProof } from '../circuits';
...
import { InputGenerator } from './inputs-generator';
/**
...
export class ProofService {
    ...
    async transitState(did, oldTreeState, isOldStateGenesis, stateStorage, ethSigner) {
        ...
        const authClaimIncProofNewState = await this._identityWallet.generateCredentialMtp(did, authInfo.credential, newTreeState);
