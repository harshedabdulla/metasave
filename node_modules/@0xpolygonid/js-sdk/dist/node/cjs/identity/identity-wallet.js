...
class IdentityWallet {
    ...
    constructor(_kms, _storage, _credentialWallet, _opts) {
        ...
        if (!_opts?.credentialStatusPublisherRegistry) {
            this._credentialStatusPublisherRegistry = new credential_status_publisher_1.CredentialStatusPublisherRegistry();
            this._credentialStatusPublisherRegistry.register(verifiable_1.CredentialStatusType.Iden3ReverseSparseMerkleTreeProof, new credential_status_publisher_1.Iden3SmtRhsCredentialStatusPublisher());
        }
        else {
    ...
    async createIdentity(opts) {
        ...
        await this._storage.mt.addToMerkleTree(tmpIdentifier, storage_1.MerkleTreeType.Claims, authClaim.hiHv().hi, authClaim.hiHv().hv);
        ...
        const mtpProof = new verifiable_1.Iden3SparseMerkleTreeProof({
            ...
            issuerData: {
                ...
                state: {
                    ...
                    revocationTreeRoot: js_merkletree_1.ZERO_HASH,
                    claimsTreeRoot: ctr,
                    value: currentState
                }
            },
