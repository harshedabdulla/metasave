        ...
        for (const proofReq of requestScope) {
            ...
            if (groupId) {
                ...
                if (!groupedCredentialsCache.has(groupId)) {
                    const credWithRevStatus = await this._proofService.findCredentialByProofQuery(did, combinedQueryData.query);
            ...
            const zkpRes = await this._proofService.generateProof(proofReq, did, {
                verifierDid: js_iden3_core_1.DID.parse(authRequest.from),
