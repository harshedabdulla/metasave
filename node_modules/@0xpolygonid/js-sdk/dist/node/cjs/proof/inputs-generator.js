...
const circuitValidator = {
    [circuits_1.CircuitId.AtomicQueryMTPV2]: { maxQueriesCount: 1 },
    [circuits_1.CircuitId.AtomicQueryMTPV2OnChain]: { maxQueriesCount: 1 },
    [circuits_1.CircuitId.AtomicQuerySigV2]: { maxQueriesCount: 1 },
    [circuits_1.CircuitId.AtomicQuerySigV2OnChain]: { maxQueriesCount: 1 },
    [circuits_1.CircuitId.AtomicQueryV3]: { maxQueriesCount: 1 },
    [circuits_1.CircuitId.AtomicQueryV3OnChain]: { maxQueriesCount: 1 },
    [circuits_1.CircuitId.AuthV2]: { maxQueriesCount: 0 },
    [circuits_1.CircuitId.StateTransition]: { maxQueriesCount: 0 },
    [circuits_1.CircuitId.LinkedNullifier]: { maxQueriesCount: 1 },
    [circuits_1.CircuitId.LinkedMultiQuery10]: { maxQueriesCount: 10 }
};
class InputGenerator {
    constructor(_identityWallet, _credentialWallet, _stateStorage) {
        ...
        this.credentialAtomicQueryMTPV2PrepareInputs = async ({ preparedCredential, identifier, proofReq, params, circuitQueries }) => {
            ...
            query.operator = query.operator === circuits_1.Operators.SD ? circuits_1.Operators.EQ : query.operator;
        ...
        this.credentialAtomicQueryV3PrepareInputs = async ({ preparedCredential, identifier, proofReq, params, circuitQueries }) => {
            ...
            circuitInputs.skipClaimRevocationCheck = params.skipRevocation;
            const query = circuitQueries[0];
            query.values = query.operator === circuits_1.Operators.SD ? new Array(64).fill(0) : query.values;
            circuitInputs.query = query;
            circuitInputs.currentTimeStamp = (0, js_iden3_core_1.getUnixTimestamp)(new Date());
        ...
        this.credentialAtomicQueryV3OnChainPrepareInputs = async ({ preparedCredential, identifier, proofReq, params, circuitQueries }) => {
            ...
            try {
                js_iden3_core_1.Id.ethAddressFromId(circuitInputs.id);
            }
            catch {
                isEthIdentity = false;
            }
        ...
        this.linkedNullifierPrepareInputs = async ({ preparedCredential, identifier, proofReq, params }) => {
            const circuitClaimData = await this.newCircuitClaimData(preparedCredential);
            circuitClaimData.nonRevProof = (0, common_1.toClaimNonRevStatus)(preparedCredential.revStatus);
            const circuitInputs = new circuits_1.LinkedNullifierInputs();
            circuitInputs.linkNonce = params.linkNonce ?? BigInt(0);
        ...
        this.linkedMultiQuery10PrepareInputs = async ({ preparedCredential, proofReq, params, circuitQueries }) => {
            const circuitClaimData = await this.newCircuitClaimData(preparedCredential);
            circuitClaimData.nonRevProof = (0, common_1.toClaimNonRevStatus)(preparedCredential.revStatus);
            ...
            circuitInputs.queryLength = circuitValidator[proofReq.circuitId].maxQueriesCount;
            return circuitInputs.inputsMarshal();
        };
    }
