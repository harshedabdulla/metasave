...
class AtomicQueryV3Inputs extends common_1.BaseConfig {
    ...
    inputsMarshal() {
        ...
        if (this.proofType === verifiable_1.ProofType.BJJSignature) {
            ...
            s.issuerAuthClaimMtp = (0, common_1.prepareSiblingsStr)(this.claim.signatureProof?.issuerAuthIncProof.proof, this.getMTLevel());
            ...
            s.issuerAuthClaimNonRevMtp = (0, common_1.prepareSiblingsStr)(this.claim.signatureProof?.issuerAuthNonRevProof.proof, this.getMTLevel());
